      ...
      <div class="row">
        <nav class="navbar navbar-default">
          ...
          <div id="mz-header-subscribe" class="hidden-xs hidden-sm">
            <div>
              ...
              <div class="mz-header-rtCol">
                ...
                <a class="subscribe-red-btn" href="https://readerservices.makezine.com/mk/default.aspx?pc=MK&pk=M7HMKT" target="_blank">SUBSCRIBE<span> &amp; save</span></a>
              </div>
            </div>
          </div>
          ...
          <div class="sticky-subscribe">
            <a class="subscribe-red-btn" href="https://readerservices.makezine.com/mk/default.aspx?pc=MK&pk=M7HMSB" target="_blank">SUBSCRIBE<span> &amp; save</span></a>
            <a class="mz-header-signin" href="/account" target="_blank">Sign In</a> 
          </div>
