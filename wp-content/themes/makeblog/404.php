  ...
  <div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8">
      <div class="caption404">
        ...
        <p class="body404">It must have moved or mysteriously departed. Use search in the top navigation to find a related story or head straight to the Makezine home page.</p>
      </div>
    </div>
  </div>
  <div class="row">
