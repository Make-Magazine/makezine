   ...
   <div class="gift-guide">
      ...
      <div class="container item-list">
         ...
         <transition-group name="list" tag="p">
            <!-- <span v-for="post in posts" v-bind:key="post._id" class="list-item">
               {{ post.item_name }}
            </span> -->
            <GiftGuideItem v-for="post in posts" v-bind:key="post._id" v-bind:post="post"></GiftGuideItem>
         </transition-group>

            <!-- <GiftGuideItem v-for="post in posts" v-bind:key="post.id" v-bind:post="post"></GiftGuideItem> -->
...
module.exports = {
   data: function() {
      return {
         ...
         posts: [], // this is a mutable copy of the list that gets displayed after being filtered & sorted
         postLimit: 12
      }
   },
   created: function() {
   ...
   methods : {
      ...
      showPosts: function() {
         this.posts = this.origPosts;//.slice(0,this.postLimit);
      },
