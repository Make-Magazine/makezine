...
<!--  Home "waist" Promos -->
      ...
      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="event-sponsored">
        <a href="/summer-of-making/?utm_source=cspromobar&utm_medium=site&utm_campaign=summermaking16" target="_blank">
          <img src="<?php echo get_template_directory_uri().'/version-2/img/promos/SOM_Inner Site Promo_B_@x2.png' ?>" class="img-responsive center-block event" alt="Summer of Making" />
        </a>
      </div>
