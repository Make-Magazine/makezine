...
<!--  Berlin / School / World Maker Faire -->
      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="event-faire">
                <a href="https://www.humblebundle.com/morebooks">
          <img src="<?php echo get_template_directory_uri().'/version-2/img/promos/promo_giftguide_humble4.jpg' ?>" class="img-responsive center-block event" />
 </a>
      </div> 
