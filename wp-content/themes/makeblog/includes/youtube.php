...
function make_youtube_embed($width,$height) {
	...
	$url = 'https://www.youtube.com/embed/' . urlencode( $big_video ) . '?showinfo=0&amp;hd=1&amp;mode=transparent';
...
function make_youtube_iframe($id, $width = 605, $height = 340) {
	if ( empty( $id ) ) {
		...
		$url = esc_url( 'https://www.youtube.com/embed/' . $id . '?showinfo=0&amp;hd=1&amp;mode=transparent' );
