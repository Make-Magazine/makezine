...
function make_load_resources() {
  ...
  wp_enqueue_style( 'font-awesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css', false );
	...
	wp_enqueue_script( 'header-version-2', get_stylesheet_directory_uri() . '/version-2/js/header.js', array( 'jquery' ));
	wp_enqueue_script( 'single-story', get_stylesheet_directory_uri() . '/version-2/js/single-story.js', array( 'jquery' ));
