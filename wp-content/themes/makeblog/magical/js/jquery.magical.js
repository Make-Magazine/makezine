(function($) {
    ...
    $.fn.unicornblast = function(options) {
		...
		return this.each(function() {
			...
			var content = '<img id="bigRainbow" style="display: none" src="/wp-content/themes/makeblog/magical/img/rainbow.gif" />';
			content += '<img id="flyingUnicorn0" class="flyingUnicorn" style="display: none" src="/wp-content/themes/makeblog/magical/img/flyingUnicorn0.gif" />';
			content += '<img id="flyingUnicorn1" class="flyingUnicorn" style="display: none" src="/wp-content/themes/makeblog/magical/img/flyingUnicorn1.gif" />';
			content += '<img id="flyingUnicorn2" class="flyingUnicorn" style="display: none" src="/wp-content/themes/makeblog/magical/img/flyingUnicorn2.gif" />';
			content += '<img id="flyingUnicorn3" class="flyingUnicorn" style="display: none" src="/wp-content/themes/makeblog/magical/img/flyingUnicorn3.gif" />';
