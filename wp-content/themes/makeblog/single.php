...
<script type="text/javascript">
	...
	var resetMobile = function (newIdentifier, newUrl, newTitle, newLanguage, postId) {
		$('#disqus_thread').remove();
		var thisButton = document.getElementsByClassName(postId);
		$(thisButton).after('<div id="disqus_thread"></div>');
		DISQUS.reset({
			reload: true,
			config: function () {
				this.page.identifier = newIdentifier;
