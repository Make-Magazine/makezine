						...
						<nav class="span12 site-navigation secondary-navigation">
							<ul id="menu-make-secondary-nav" class="nav navbar-nav ga-nav clearfix">
								...
								<li class="menu-item dropdown"><a href="#" class="dropdown-toggle">Contests</a>
									<ul class="sub-menu dropdown-menu">
										<li><a target="_blank" href="<?php echo esc_url( home_url( '/pitch-your-prototype-2015/' ) ); ?>">Pitch Your Prototype</a></li>
										<li><a target="_blank" href="<?php echo esc_url( home_url( '/psoc-maker-challenge/' ) ); ?> ">PSoC Maker Challenge 2015</a></li>
										<li><a target="_blank" href="<?php echo esc_url( home_url( '/launchpad-contest/' ) ); ?>">Launchpad at MakerCon</a></li>
									</ul>
								</li>
								<li class="menu-item dropdown"><a href="#" class="dropdown-toggle">Contests</a>
									<ul class="sub-menu dropdown-menu">
										<li><a target="_blank" href="//makezine.com/pitch-your-prototype-2015/">Pitch Your Prototype</a></li>
										<li><a target="_blank" href="//makezine.com/psoc-maker-challenge/">PSoC Maker Challenge 2015</a></li>
