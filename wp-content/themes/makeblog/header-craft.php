					...
					<div class="row">
						...
						<div class="additional-content hidden-print">
							...
							<div class="hdr-sub-ad-01" >
								<a href="https://www.readerservices.makezine.com/MK/subscribe.aspx?PC=MK&amp;PK=M3BMZA"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/img/hdr-mag-sub-43.jpg"  alt="Subscribe to Make Magazine Today!" /></a>
							</div>
						</div>
					</div>
				</div>
						...
						<nav class="span12 site-navigation secondary-navigation">
							<ul id="menu-make-secondary-nav" class="nav navbar-nav ga-nav clearfix">
								...
								<li class="menu-item dropdown"><a href="#" class="dropdown-toggle">Publications</a>
									<ul class="sub-menu dropdown-menu">
										<li><a target="_blank" href="https://www.readerservices.makezine.com/MK/subscribe.aspx?PC=MK&PK=M3BMZA">Subscribe to Make:</a></li>
