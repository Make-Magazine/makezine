					...
					<div class="row">
						<nav class="span12 site-navigation secondary-navigation">
							<ul id="menu-make-secondary-nav" class="nav navbar-nav ga-nav clearfix">
								...
								<li class="nav-item"><a href="http://sprout.makezine.com?utm_source=makezine.com&utm_medium=referral&utm_campaign=nav+link" target="_blank"><img src="/wp-content/themes/makeblog/images/sprout.png" alt="Sprout Logo" class="nav-sprout"/></a>									
								</li>
							</ul>
						</nav>
					</div>
