...
class ESSB_Mobile_Detect
{
    ...
    protected static $phoneDevices = array(
        ...
        'GenericPhone'  => 'lscache_runner Mobile|Tapatalk|PDA;|SAGEM|\bmmp\b|pocket|\bpsp\b|symbian|Smartphone|smartfon|treo|up.browser|up.link|vodafone|\bwap\b|nokia|Series40|Series60|S60|SonyEricsson|N900|MAUI.*WAP.*Browser',
    );
