...
ESSBOptionsStructureHelper::field_section_start('social', 'sharing-23', __('Twitter message optimization', 'essb'), __('Twitter message optimization allows you to truncate your message if it exceeds the 140 characters length of message.', 'essb'), '');
