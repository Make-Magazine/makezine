...
?>
	<h3><?php _e( 'Notice', 'quick-featured-images-pro' ); ?></h3>
...
?>
	<h3><?php _e( 'Select the featured images you want to replace by the selected image.', 'quick-featured-images-pro' ); ?></h3>
...
?>
<h3><?php _e( 'Refine your selections', 'quick-featured-images-pro' ); ?></h3>
...
?>
	<h4><?php _e( 'Optional: Select options', 'quick-featured-images-pro' ); ?></h4>
<?php
...
<?php
	...
	if ( 'assign_first_img' == $this->selected_action ) {
?>
	<h4><?php _e( 'Some advices from experience', 'quick-featured-images-pro' ); ?></h4>
...
?>
	<h4><?php _e( 'Optional: Add a filter', 'quick-featured-images-pro' ); ?></h4>
	<fieldset>
...
<h4><?php _e( 'If you encounter a white, blank page, read this', 'quick-featured-images-pro' ); ?></h4>
