...
?>
<h3><?php _e( 'Preview of your selection', 'quick-featured-images-pro' ); ?></h3>
<h4><?php printf( __( '%d matches found', 'quick-featured-images-pro' ), sizeof( $results ) ); ?></h4>
<?php 
if ( $results ) { 
...
<h3><?php _e( 'Confirm the change', 'quick-featured-images-pro' ); ?></h3>
