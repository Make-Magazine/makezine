 ...
 */
 ...
 class Quick_Featured_Images_Pro_Admin {
	...
	public function get_page_description() {
		return __( 'Your time-saving Swiss Army Knife for featured images: Set, replace and delete them in bulk, set default images, get overview lists.', 'quick-featured-images-pro' );
	}
	...
	public function display_activation_message () {
		...
		$msg  = sprintf( __( 'Welcome to %s! You can find the plugin at %s.', 'quick-featured-images-pro' ), $this->plugin_name, $link );
