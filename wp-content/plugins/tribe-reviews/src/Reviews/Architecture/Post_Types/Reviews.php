		...
		register_field_group( array(
            ...
            array(
              ...
              'type'          => 'image',
				...
				array(
					'key'   => 'field_56304b50e3847',
					'label' => 'Videos',
					'name'  => '',
					'type'  => 'tab',
				),
				array(
					'key'           => 'field_56304b05c6e88',
					'label'         => 'Sidebar Text Title',
					'name'          => 'yt_sidebar_title',
					'type'          => 'text',
					'default_value' => '',
					'placeholder'   => '',
					'prepend'       => '',
				...
				array(
					'key'               => 'field_56304b9b0hd3e',
					'label'             => 'Youtube videos for the right sidebar.',
					'name'              => 'youtube_videos',
					'type'              => 'repeater',
					'sub_fields'        => array(
						array(
							'key'           => 'field_56304baf0jh56',
							'label'         => 'Youtube video ID. i.e. CsGYh8AacgY',
							'name'          => 'video_id',
							'type'          => 'text',
							'column_width'  => '',
							'default_value' => '',
     ...
     // print_r($prodcut_scores);
		foreach ( $prodcut_scores as $product_id => $scores ) {
       	...
       	p2p_update_meta( $p2p_id, $key, $value );
			...
			$totalscore= p2p_get_meta( $p2p_id, 'possible-score', true );
